        ...
        NavigationView {
            ZStack {
                ...
                VStack {
                    ...
                    NavigationLink(destination: TimerView(), isActive: $showingLoginScreen) {
                        EmptyView() 
                    }
                    ...
                    NavigationLink(destination: PaginaHome(), isActive: $showingLoginScreen) {
                        EmptyView()
                    }
                }
